...
class EditCustomer extends Component {
    ...
    //         }
    //     }
    //     axios.post(`${API_URL}/customer/${this.props.match.params.id
    ...
    handleSubmit(e) {
        ...
        axios.post(`${API_URL}/customer/update/${this.props.match.params.id}`, payload, config).then(res => {
           if(res.status === 200 && res.statusText === 'OK'){
            this.props.history.push('/admin/customer');
           }else{
               console.log('error in edit new customer');
           } 
        });
